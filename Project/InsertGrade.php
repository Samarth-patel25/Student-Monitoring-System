...
<div class="container">
    ...
    <div class="home">
        ...
        <!-- <ul>
            <li><a href="MathsGrade.php">Mathematics-II</a></li><br>
            <li><a href="SCPGrade.php">Semiconductor Physics</a></li><br>
            <li><a href="PPSGrade.php">PPS-II</a></li><br>
            <li><a href="HWGrade.php">Hardware Workshop</a></li><br>
            <li><a href="EnglishGrade.php">English</a></li><br>
            <li><a href="EVSGrade.php">EVS</a></li><br>
        </ul> -->
        <div class="action">
